...
public class TwoWheelTrackingLocalizerCoefficients {
    ...
    public static class Builder {
         ...
         * @return The builder
         */
        public TwoWheelTrackingLocalizerCoefficients.Builder setXMultiplier(double forwardMul) {
         ...
         * @return The builder
         */
        public TwoWheelTrackingLocalizerCoefficients.Builder setYMultiplier(double strafeMul) {
