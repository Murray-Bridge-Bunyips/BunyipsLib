...
public class RedSample extends ColourThreshold {
    @NonNull
    public static Scalar LOWER_YCRCB = new Scalar(0, 140, 0);
    @NonNull
    public static Scalar UPPER_YCRCB = new Scalar(110, 255, 255);
    ...
    /**
     * Create a new Red Sample detector.
     */
    public RedSample() {
