...
class QuinticSpline(
    ...
    class Knot @JvmOverloads constructor(
        ...
        constructor(
            pos: Vector2d,
            deriv: Vector2d = Vector2d(0.0, 0.0),
            secondDeriv: Vector2d = Vector2d(0.0, 0.0)
        ...
        /**
         * First derivative of the Knot
         */
        fun deriv() = Vector2d(dx, dy)

        /**
         * Second derivative of the Knot
         */
    ...
    private fun approxLength(v1: Vector2d, v2: Vector2d, v3: Vector2d): Double {
        ...
        return if (det approx 0.0) {
            ...
            val radius = Geometry.distBetween(origin, v1)
